...
OE_SUPERADMIN="yourpwd"
# Set to "True" to generate a random password, "False" to use the variable in OE_SUPERADMIN
GENERATE_RANDOM_PASSWORD="False"
OE_CONFIG="${OE_USER}-server"
# Set the website name
WEBSITE_NAME="autoparts2020.net"
# Set the default Odoo longpolling port (you still have to use -c /etc/odoo-server.conf for example to use this.)
LONGPOLLING_PORT="8072"
# Set to "True" to install certbot and have ssl enabled, "False" to use http
ENABLE_SSL="True"
# Provide Email to register ssl certificate
ADMIN_EMAIL="autopartscenter2020@gmail.com"
##
...
sudo apt install git python3 python3-pip build-essential wget python3-dev python3-venv python3-wheel libxslt-dev libzip-dev libldap2-dev libsasl2-dev python3-setuptools node-less libpng12-0 libjpeg-dev gdebi -y
...
#   if [ "`getconf LONG_BIT`" == "64" ];then
#       sudo dpkg install /home/sysadmin/odoo-install-script/wkhtmltox_0.12.5–1.bionic_amd64.deb
#   else
#       sudo dpkg install /home/sysadmin/odoo-install-script/wkhtmltox_0.12.5–1.bionic_i386.deb
#   fi
